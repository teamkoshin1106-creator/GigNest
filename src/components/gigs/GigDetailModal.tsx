      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          <div className="flex h-full flex-col">
            <div className="flex items-center justify-between border-b border-slate-50 p-6 sm:px-10">
            ...
            <div className="flex-1 overflow-y-auto p-6 sm:p-10">
              ...
              <div className="rounded-3xl bg-slate-50 p-8 border border-slate-100">
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-text-secondary">Client</p>
            ...
            <div className="border-t border-slate-50 bg-white p-8 sm:px-10">
